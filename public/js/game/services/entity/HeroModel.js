(function() {
  app.service('Hero', function(Arrow) {
    ...
    return function(game, phaser, meta) {
      ...
      this.createArrows = function() {
        return this.arrow = Arrow(this.game);
      };
      ...
      this.renderMissiles = function(x, y, angle, num) {
        var arrow, i, thisAngle, _i, _results;
        _results = [];
        for (i = _i = 0; 0 <= num ? _i < num : _i > num; i = 0 <= num ? ++_i : --_i) {
          arrow = this.arrow.arrows.children[arrowIndex];
          arrow.reset(x, y);
      ...
      return this._setControls = function() {
