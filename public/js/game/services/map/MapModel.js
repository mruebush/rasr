(function() {
  app.service('Map', function() {
    return function(game, Phaser, mapId, $) {
      ...
      this.preload = function(direction, data, callback) {
        var that, url,
          _this = this;
        that = this;
      ...
      this._loadAssets = function(data, loader) {
      ...
      this.reloadMap = function(loader, direction) {
        var that, url,
          _this = this;
        that = this;
        url = "" + this.game.rootUrl + "/move/" + direction + "/" + this.mapId;
      ...
      this.reload = function(direction) {
      ...
      this._createCtrls = function(data) {
      ...
      return this._makeMap = function(direction, mapId) {
        return this.$.ajax({
