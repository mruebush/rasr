...
module.exports = function() {
  ...
  methods.populateScreen = function(req, res) {
    ...
    .then(function(createdScreen) {
      ...
      return screenHandler.createWorld('right', screen2, createdScreen._id);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('down', screen3, createdScreenId);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('left', screen4, createdScreenId);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('left', screen5, createdScreenId);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('up', screen6, createdScreenId);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('up', screen7, createdScreenId);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('right', screen8, createdScreenId);
    })
    .then(function(createdScreenId) {
      console.log(createdScreenId);
      return screenHandler.createWorld('right', screen9, createdScreenId);
    })
    .then(function(createdScreenId) {
