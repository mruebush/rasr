...
module.exports.init = function(server) {
  ...
  io.on('connection', function(socket){
    ...
    socket.on('join', function(data) {
      ...
      console.log('extended', users[user]);
      ...
      console.log('get', getOtherUsersInRoom(room, user));
            ...
            if (callbacksFired === _len) {
              ...
              io.in(room).emit(room, {
                ...
                enemies: allEnemies[room]
                    ...
                    console.log('get', get(users, room, user));
      console.log('all', users[user])
            }
          });
        }
...
var getOtherUsersInRoom = function(room, user) {
  ...
  for (var otherUser in users) {
    ...
    console.log(users[otherUser].room, room)
    if (users[otherUser].room === room && otherUser !== user) {
      obj = users[otherUser];
      obj.user = otherUser;
      res.push(obj);
      console.log('obj', obj)
