...
var sampleEnemies = require('../util/sampleEnemies');
...
exports.createPlacedScreen = function(req, res) {
  var direction = req.param('direction');
...
exports.createWorld = function(direction, newScreen, currentObjectId, req, res) {
  var adjacentDirections = {
    'up': 'right',
    'right': 'down',
    'down': 'left',
  ...
  .then(function(createdScreenId) {
    return exports.addDirectionReference(direction, currentObjectId, createdScreenId)
  })
  // go around the horn, adding all necessary references
  .then(function(createdScreenId) {
    return exports.placementHelper(currentObjectId, createdScreenId, direction, adjacentDirections[direction]);
